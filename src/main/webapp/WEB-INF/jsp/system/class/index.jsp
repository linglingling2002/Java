        ...
        table.on('toolbar(classTable)',function (obj) {
            ...
            switch (e){
                ...
                case "batchDelete":
                    ...
                    layer.confirm('确认要删除吗？',{icon:5,title:'友情提示'},function (index) {
                        var params = "";
...
<script type="text/html" id="toolbarDemo">
    <div class="layui-btn-container">
        ...
        <shiro:hasPermission name="class:delete">
            <button class="layui-btn layui-btn-sm layui-btn-danger" lay-event="batchDelete"><i class="layui-icon layui-icon-delete"></i> 删除</button>
        </shiro:hasPermission>
  </div>
</script>
</body>
